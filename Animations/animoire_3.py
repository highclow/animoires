...
def getAnimation(animationBasesFactory, scalerFactory):
    ...
    shape1 = Ellipse(initialPosition1, radius, ellispeScaleValues,
        lineProperties, repeater=scaleRepeater)
